...
There are a total of **5 fixes** you need to make to the workflow below. To complete this assignment you must ***1)*** Identify the 5 errors and specify what they are below (*1 pt each*) and ***2)*** fix the errors and render this entire .Rmd as am HTML doc where the content below matches that of the `01-debugging_code_output.html` (*5 pts*).

**List here the 5 errors you had to fix in this workflow:**

1.  Set `echo = FALSE` to remove code
